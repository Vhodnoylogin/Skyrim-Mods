...
Путей к конкретной машине в проверках нет: папка плагина выводится от расположения файла, имя
файла с токеном — от имени этой папки, порт берётся из `MO2AILINK_PORT` (по умолчанию 8930).
