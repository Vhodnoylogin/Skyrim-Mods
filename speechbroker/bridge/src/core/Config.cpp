...
#include "SpeechBrokerDefaults.h"
...
namespace SpeechBroker
{
	...
	{
		switch (a_origin) {
		case Origin::Created: return "$SPEECHBROKER_CFG_CREATED";
		case Origin::Merged:  return "$SPEECHBROKER_CFG_MERGED";
		case Origin::File:    return "$SPEECHBROKER_CFG_FILE";
		case Origin::Broken:  return "$SPEECHBROKER_CFG_BROKEN";
		default:              return "$SPEECHBROKER_CFG_BASELINE";
		}
	}
