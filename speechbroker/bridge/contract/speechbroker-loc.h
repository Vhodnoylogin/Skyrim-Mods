/* Speech Broker - reading the text a module puts out. Header only.
 *
 * Every line a module shows or writes down is a key, and the text behind the key
 * lives in Skyrim's own translation files: Interface\Translations\SpeechBroker*_<language>.txt,
 ...
 *
 * Files are picked up by name: SpeechBroker*_<language>.txt. A mod that wants its own strings
...
namespace SpeechBrokerLoc
{
	...
	private:
		...
		// SpeechBroker*_<language>.txt, compared without regard to case: what a translator
