# Speech Broker - the space of snapshot keys

*In Russian: [speechbroker-keys.ru.md](speechbroker-keys.ru.md). English is the source language; the other is a translation.*
...
| `speechbroker.*`    | the service of models itself |
...
## The optional namespaces
    ...
    speechbroker.noiseLevel                float   the level of noise on the microphone
