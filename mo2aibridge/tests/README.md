...
| `test_contract_offline.py` | нет | контракт всех 24 маршрутов на подставном `mobase` (`fake_mo2.py`): ключи ответов, оба замка, запись `plugins.txt`, установка на настоящей временной папке |
