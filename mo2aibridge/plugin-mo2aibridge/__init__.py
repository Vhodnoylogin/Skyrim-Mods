...
# зовётся пакет при импорте. Имя папки в репозитории с ним не совпадает намеренно -
# там plugin-mo2aibridge, чтобы не повторять имя модуля трижды подряд, - поэтому имя
